  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sahara Multi Fitness Unisex — Train Like a Champion" },
      {
        ...
        content:
          "Luxury gym in Gangavathi. Train under Mr. World champion coach Suleman Mustafa. Strength, transformation, discipline.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Inter:wght@300;400;500;600;700;800&family=Oswald:wght@400;600;700&display=swap",
      },
    ],
  }),
